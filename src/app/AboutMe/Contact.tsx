                    ...
                    <div className="col-12 col-md-5 mb-3">
                        <div className="card text-white shadow" style={{ background: "#1d1f2a", height: "100%" }}>
                            <div className="card-body text-center">
                                ...
                                <a href="mailto:matheodupuis1@gmail.com" className="btn btn-info text-white mt-2 w-auto"><strong>Me contacter</strong></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card text-white shadow" style={{ background: "#1d1f2a", height: "100%" }}>
                            <div className="card-body text-center">
                                ...
                                <a href={"https://github.com/MatheoD16"} target={'_blank'}>
                                    <div style={{ position: 'relative', width: '100%', height: '75px' }} className={"mt-2 mb-2"}>
